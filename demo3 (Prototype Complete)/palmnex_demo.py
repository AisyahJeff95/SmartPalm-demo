...
<body>
  ...
  <script>
    ...
    function downloadReport() {
      ...
      reportEl.innerHTML = `
        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #2d6a4f; padding-bottom: 12px; margin-bottom: 20px;">
          <div>
            <h1 style="margin: 0; color: #2d6a4f; font-size: 22px; font-weight: 700; letter-spacing: -0.5px; font-family: 'Outfit', sans-serif;">PRECIPALM</h1>
            <div style="font-size: 10px; color: #718096; font-weight: 600; margin-top: 2px; text-transform: uppercase; letter-spacing: 0.5px;">Crop Nutrient Analytics Report</div>
          </div>
          <div style="text-align: right;">
            <div style="font-size: 11px; font-weight: 700; color: #2d3748;">PALMNEX SYSTEM</div>
            <div style="font-size: 9px; color: #a0aec0; margin-top: 2px;">Powered by Palmnex</div>
          </div>
        </div>
