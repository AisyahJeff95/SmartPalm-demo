...
filepath = 'standard.html'
with open(filepath, 'r', encoding='utf-8') as f:
    content = f.read()

pattern = r'<!-- Sidebar Controls -->\s*<div class="sidebar">.*?<!-- Map Area -->'
match = re.search(pattern, content, flags=re.DOTALL)
if match:
    new_content = content[:match.start()] + std_sidebar + "\n\n            <!-- Map Area -->" + content[match.end():]
